<?php
	...
	if(empty($allPost)) {
		...
		$onePage = 1522; // 한 페이지에 보여줄 게시글의 수.
...
<center>
	<div class="container">
		...
		<div class="row"> 
			<h2> Booth Registration 부스 신청 현황</h2>
		</div>

		<div class="row">
			<img src="http://kaffoc.org/kr/images/booth_map_oc.jpg" alt="" width="100%">
			<br><br><br> 
				<a href="./write.php">
		...
		?>
			...
			<div class="col-sm-3">
				<div class='thumbnail <?php if($row["b_hit"] == 0) echo "Available"; ?>'>
					<b><?php echo $row['b_title']?></b> <br> 
					<?php 
						if($row['b_hit'] == 1) {
							echo 'Not Available';
						} else {
